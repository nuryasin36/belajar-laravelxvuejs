        ...
        <div class="col-md-3 col-sm-6 col-xs-12" v-for="book in filteredList">
            <div class="info-box" v-on:click="editData(book)">
                <div class="info-box-content text-truncate">
                    ...
                    <span class="info-box-number">Rp@{{ numberWithDot(book.price) }},-<small></small></span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <form method="post" :action="actionUrl" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Catalog</label>
                            <select name="catalog_id" class="form-control" id="">
            ...
            deleteData(id) {
                this.actionUrl = '{{ url('books') }}'+'/'+id;
                    ...
                    if (confirm("Are You sure wanna delete this?")) {
                        axios.post('{{ url('books') }}'+'/'+id, {_method: 'DELETE'}).then(response =>{
                            location.reload();
                        });
                        ...
                        // .then(response => {
                        //     location.reload();
                        //     console.log("maafin yasin Ya Allah.... lancarin dong....");
                        // })
                        // 
